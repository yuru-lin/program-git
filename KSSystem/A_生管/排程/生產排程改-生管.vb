...
Public Class 現場生管查排程
    ...
    Private Sub 現場生管查排程_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub SQLDGV1Display()
        ...
        Using TransactionMonitor As New System.Transactions.TransactionScope
            ...
            sql = "    SELECT [LineNum] AS '列號', [OPDocNum] AS '排程', [U_CK02] AS '製單', [CardCode] AS '客編', [CardName] AS '客戶', [ItemCode] AS '存編', [ItemName] AS '品名', [Quantity] AS '數量', [Number] AS '人數', [Time] AS '工時', [Weight] AS '重量', [ItemSid] AS 'ItemSid' "
    ...
    Private Function setCarEntry()
        ...
        sql = " SELECT  TOP 1 [LineNum] FROM [Z_KS_Scheduling] WHERE [DocDate] = '" & dateDocDate.Value.Date & "' AND [Floor] = '" & Floor.SelectedIndex & "' AND [Period] = '" & Period.SelectedIndex & "' ORDER BY [LineNum] DESC "
