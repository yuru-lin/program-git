...
Public Class 代工快速領料作業
    ...
    Private Sub B_QckAddOIGEv5_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '倉儲
        If Login.LogonUserName = "manager" Or Login.LogonUserName = "ks10" Or Login.LogonUserName = "KS10" Then
    ...
    Private Sub SelectDGV1()
        ...
        Using TransactionMonitor As New System.Transactions.TransactionScope
            ...
            If CheckBox1.Checked = True Then
                sql = "    SELECT [FI101] AS '生產單號', [FI106] AS '領料製單', [FI107] AS '入庫單號', [FI109] AS '出庫單號', [FI103] AS '是否入庫' "
                sql += "     FROM [@FI1Main]"
                sql += "    WHERE  [FI103] IN ('3','4') AND [FI104] = 'Y' AND [FI109] IS NULL AND [FI105] <= '" & Format(FI1052.Value.Date, "yyyy/MM/dd") & "' "
                sql += " ORDER BY 2 "
