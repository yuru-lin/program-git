...
Public Class 出庫作業V101Bak20161005   '20140917
    ...
    Private Sub 同步SAP2()  '出貨作業別類 = ["銷售"]
        ...
        For j As Integer = 0 To T2DGV1.RowCount - 1
            ...
            oDelv.Lines.PriceAfterVAT = 
            'oDelv.Lines.LineTotal = 
            'Select Case T2DGV2.Rows(j).Cells("管理").Value
            '    Case "B"
            If T2DGV1.Rows(j).Cells("計價單位").Value = 2 Then
                oDelv.Lines.UnitPrice = T2DGV1.Rows(j).Cells("實際金額").Value * T2DGV1.Rows(j).Cells("單位2數量").Value / T2DGV1.Rows(j).Cells("出庫數量").Value
