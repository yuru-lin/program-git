...
Public Class 訂單回傳1_作業
    ...
    Private Sub 訂單回傳1_作業_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
...
#End Region
    ...
    Private Sub btnInsert_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnInsert.Click
        ...
        Select Case laSource.Text
            Case "網路通路"
                訂單回傳2_作業.Source = "EC"
                訂單回傳2_作業.KEY = laID.Text
                訂單回傳2_作業.CardCode = laCardCode.Text
                訂單回傳2_作業.CardName = laCardName.Text
                訂單回傳2_作業.strAtttibuteType = strAtttibuteType
                訂單回傳2_作業.strOrderName = strOrderName
                訂單回傳2_作業.strOrderType = strOrderType
                訂單回傳2_作業.strOrderSource = strOrderSource
                訂單回傳2_作業.MdiParent = MainForm
                訂單回傳2_作業.Show()
                Me.Close()
            Case "員購"
                訂單回傳2_作業.Source = "Welfare"
                訂單回傳2_作業.KEY = laID.Text
                訂單回傳2_作業.CardCode = laCardCode.Text
                訂單回傳2_作業.CardName = laCardName.Text
                訂單回傳2_作業.strSaleGroupType = strSaleGroupType
                訂單回傳2_作業.MdiParent = MainForm
                訂單回傳2_作業.Show()
                Me.Close()
        End Select
