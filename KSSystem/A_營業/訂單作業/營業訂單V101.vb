...
Public Class A_營業_訂單輸入    'V 1.01  20150414
    ...
    Private Sub A_營業_訂單輸入_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub ClearAll2()
        FixedCust.Items.Clear()
        FixedCust.Items.Add("超秦企業股份有限公司")
        FixedCust.Items.Add("超秦*")
    End Sub
    ...
    Private Sub 作業01_派單新增_單據查詢()
        ...
        Try
            ...
            If T1新增CB = "Y" Then
                載入雞種_初始化()
                Dim combo, combo1 As New DataGridViewComboBoxColumn
                combo.DataSource = ks1DataSetDGV.Tables("庫存單位")
                combo.DataPropertyName = "U_P7"
                combo.DisplayMember = "庫存單位"
                combo.ValueMember = "U_P7"
                ...
                ''combo1.DataSource = ks1DataSetDGV.Tables("是否生產")
                ''combo1.DataPropertyName = "U_P3"
                ''combo1.DisplayMember = "是否生產"
                ''combo1.ValueMember = "U_P3"
                'combo1.HeaderText = "是否生產"
                ''combo1.Width = 100
                'DGV1.Columns.Insert(6, combo1)
                'DGV1.Columns.Add(combo1)
                ''combo1.Items.Add("N")
                ''combo1.Items.Add("Y")
                ''combo1.Selected = 1
                T1新增CB = "N"
    ...
    Private Sub SearchBtn2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SearchBtn2.Click
        ...
        If DGV2.RowCount > 0 Then : ks2DataSetDGV.Tables("DT1").Clear() : End If
        ...
        SQLQuery = "  SELECT T0.[ItemCode] AS 'ItemCode', T0.[ItemName] AS 'Dscription', T0.[OnHand], T0.[SalPackUn] AS 'U_P4', T0.[SalPackMsr] AS 'U_P6' "
        ...
        'SQLQuery += "    AND T0.[ItemName] Like '%" & 品W1.Text & "%' AND T0.[ItemName] Like '%" & 品W2.Text & "%'  AND T0.[ItemName] Like '%" & 品W3.Text & "%' "
        ...
        Try
            ...
            'DataAdapterDGV.Fill(ks2DataSetDGV, "ItemCode1")
            'DataAdapterDGV.Fill(ks2DataSetDGV, "ItemCode1s")
            'dt1 = ks2DataSetDGV.Tables("ItemCode1")
            'dt2 = ks2DataSetDGV.Tables("ItemCode1s")
            'DGV2.DataSource = dt1
            'If 新增CB存編 = "Y" Then
            '    Dim checkBoxColumn As New DataGridViewCheckBoxColumn()
            '    checkBoxColumn.Name = "選擇"
    ...
    Private Sub SelectU_CarDr()
        ...
        Using TransactionMonitor As New System.Transactions.TransactionScope
            ...
            U_CarDr1.DataSource = ksSelectDataSet.Tables("UC1").Copy : U_CarDr1.DisplayMember = "司機"
            U_CarDr2.DataSource = ksSelectDataSet.Tables("UC1").Copy : U_CarDr2.DisplayMember = "司機"
            U_CarDr3.DataSource = ksSelectDataSet.Tables("UC1").Copy : U_CarDr3.DisplayMember = "司機"
